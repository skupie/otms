                    ...
                    <ul class="side-menu">
                        ...
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                                ...
                                <span class="side-menu__label">Teacher Module</span><i class="angle fa fa-angle-right"></i></a>
                            <ul class="slide-menu">
                                <li class="side-menu-label1"><a href="javascript:void(0)">Tables</a></li>
                                <li><a href="tables.html" class="slide-item">Add Teacher</a></li>
                                <li><a href="datatable.html" class="slide-item">Manage Teacher</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <li class="slide">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="avatar.html" class="slide-item">Manage User</a></li>
                            </ul>
                        </li>
                        <li class="slide">
                            <a class="side-menu__item" data-bs-toggle="slide" href="#">
                            ...
                            <ul class="slide-menu">
                                ...
                                <li><a href="carousel.html" class="slide-item">Manage About</a></li>
                                <li><a href="cards.html" class="slide-item">Manage Contact</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
